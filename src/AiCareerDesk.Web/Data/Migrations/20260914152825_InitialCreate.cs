        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OwnerId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    SourceResumeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SourceJobId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    ResumeSnapshot = table.Column<string>(type: "nvarchar(max)", maxLength: 30000, nullable: false),
                    JobDescriptionSnapshot = table.Column<string>(type: "nvarchar(max)", maxLength: 20000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResumeDrafts_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StatusHistory_Jobs_JobApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Jobs_OwnerId_Status",
                table: "Jobs",
                columns: new[] { "OwnerId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_ResumeDrafts_OwnerId",
                table: "ResumeDrafts",
                column: "OwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StatusHistory_JobApplicationId_ChangedUtc",
                table: "StatusHistory",
