...
Six automated tests cover retries, rollback, conflicting IDs, reorder boundaries, invalid inputs, and two concurrent sales competing for the last item. Tests use disposable databases.
